...
export default function ReviewPage() {
  ...
  const handleDownloadPDF = () => {
    const id = trackingId || "38" + Math.random().toString().slice(2, 12);
    generatePDF(data, id);
  };
  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        ...
        >
          Your complaint PDF has been downloaded. Use the tracking ID below
          to file on the official portal.
        </motion.p>
        ...
        <motion.div
          ...
          className="inline-block bg-card border border-success/30 rounded-2xl p-6 mb-6"
        >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  If you lost money, call the helpline right now
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  Use your tracking ID and the PDF to complete filing
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  Carry the printed PDF with evidence
                </div>
              </div>
            </div>
          </div>
    ...
    <div>
      ...
      <div className="mt-6 p-4 bg-primary/5 border border-primary/20 rounded-xl">
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-medium">Complaint PDF</div>
            <div className="text-xs text-muted-foreground mt-1">
              A detailed complaint document will be generated with: your
              details, incident info, applicable BNS/IT Act sections, evidence
              list, and legal declaration. Ready to file at a police station or
      ...
      <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-xl">
        <p className="text-xs text-amber-700">
          By submitting, you confirm the information is accurate. False
          complaints are punishable under BNS §217 (formerly IPC §182).
        </p>
      </div>
      ...
      <div className="flex items-center justify-between mt-8">
        <button
          onClick={() => router.push("/report/details")}
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handleDownloadPDF}
            className="px-6 py-3 bg-card border border-border hover:bg-muted rounded-xl text-sm font-medium transition-colors flex items-center gap-2"
          >
